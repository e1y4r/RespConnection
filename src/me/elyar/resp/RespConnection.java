package me.elyar.resp;

import me.elyar.resp.type.*;
...
public class RespConnection {
    ...
    public void send(String... arguments) {
        ...
        for (String argument : arguments) {
            printWriter.print("$" + argument.length() + CRLF);
    ...
    public RespType receive() throws IOException {
        ...
        if (typeChar == '+') { // 简单字符串
            ...
            int integer = Integer.parseInt(getLine(inputStream));
    ...
    public String getNChar(InputStream inputStream, int length) throws IOException {
        String r = new String(inputStream.readNBytes(length));
